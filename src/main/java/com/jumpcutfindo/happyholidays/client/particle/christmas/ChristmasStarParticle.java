...
public class ChristmasStarParticle extends SimpleAnimatedParticle {
    ...
    public ChristmasStarParticle(ClientLevel p_106531_, double p_106532_, double p_106533_, double p_106534_,
        ...
        this.rCol *= (float)(STAR_PARTICLE_COLOUR.getColor() >> 16 & 255) / 255.0F;
        this.gCol *= (float)(STAR_PARTICLE_COLOUR.getColor() >> 8 & 255) / 255.0F;
        this.bCol *= (float)(STAR_PARTICLE_COLOUR.getColor() & 255) / 255.0F;
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType p_106566_, ClientLevel p_106567_, double p_106568_, double p_106569_, double p_106570_, double p_106571_, double p_106572_, double p_106573_) {
            return new ChristmasStarParticle(p_106567_, p_106568_, p_106569_, p_106570_, p_106571_, p_106572_, p_106573_, this.sprites);
        }
    }
}
