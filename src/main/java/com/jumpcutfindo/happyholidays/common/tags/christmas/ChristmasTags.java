...
public class ChristmasTags {
    ...
    public class Items {
        ...
        public static final Tags.IOptionalNamedTag<Item> SPECIAL_WALNUTS = itemTag("special_walnuts");
    ...
    public class Entities {
        ...
        public static final Tags.IOptionalNamedTag<EntityType<?>> DEBUFFABLE_BY_STAR = entityTag("debuffable_by_star");
    }
