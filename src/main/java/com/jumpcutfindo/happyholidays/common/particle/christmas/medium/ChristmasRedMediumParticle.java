...
@OnlyIn(Dist.CLIENT)
public class ChristmasRedMediumParticle extends ChristmasMediumParticle {
    public static final String PARTICLE_ID = "christmas_red_particle";
    public static final int COLOR = 16711680;

    public ChristmasRedMediumParticle(ClientWorld world, double xCoord, double yCoord, double zCoord,
