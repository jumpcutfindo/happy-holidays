...
@OnlyIn(Dist.CLIENT)
public class ChristmasGoldMediumParticle extends ChristmasMediumParticle {
    public static final String PARTICLE_ID = "christmas_gold_particle";
    public static final int COLOR = 16764738;

    public ChristmasGoldMediumParticle(ClientWorld world, double xCoord, double yCoord, double zCoord, double xSpeed,
