...
@OnlyIn(Dist.CLIENT)
public class ChristmasMediumGreenParticle extends ChristmasMediumParticle {
    public static final String PARTICLE_ID = "christmas_medium_green_particle";
    public static final int COLOR = ParticleColor.GREEN.getColor();

    public ChristmasMediumGreenParticle(ClientLevel world, double xCoord, double yCoord, double zCoord, double xSpeed,
