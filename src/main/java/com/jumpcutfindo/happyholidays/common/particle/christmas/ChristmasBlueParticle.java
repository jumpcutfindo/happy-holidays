...
@OnlyIn(Dist.CLIENT)
public class ChristmasBlueParticle extends ChristmasParticle{
    public static final String PARTICLE_ID = "christmas_blue_particle";

    public ChristmasBlueParticle(ClientWorld world, double xCoord, double yCoord, double zCoord, double xSpeed,
