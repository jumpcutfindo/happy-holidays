...
public class SantaElfTrades {
    public static final VillagerTrades.ItemListing[] SMALL_BALL_ORNAMENT_TRADES =
    ...
    public static final VillagerTrades.ItemListing[] BIG_BALL_ORNAMENT_TRADES =
            new VillagerTrades.ItemListing[] {
    ...
    public static final VillagerTrades.ItemListing[] TINSEL_TRADES =
            new VillagerTrades.ItemListing[]{
    ...
    public static final VillagerTrades.ItemListing[] CHRISTMAS_LIGHT_TRADES =
            new VillagerTrades.ItemListing[] {
    ...
    public static final VillagerTrades.ItemListing[] HEAD_ORNAMENT_TRADES =
            new VillagerTrades.ItemListing[] {
