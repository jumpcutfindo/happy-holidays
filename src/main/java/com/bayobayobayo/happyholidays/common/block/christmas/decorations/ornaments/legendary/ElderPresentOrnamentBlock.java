...
public class ElderPresentOrnamentBlock extends LegendaryOrnamentBlock {
    public static final String BLOCK_ID = "elder_present_ornament_block";
    ...
    public ElderPresentOrnamentBlock() {
