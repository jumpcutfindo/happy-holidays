...
public class BigBlueBallOrnamentBlock extends BigBaubleOrnamentBlock {
    public static final String BLOCK_ID = "big_blue_ball_ornament_block";

    public BigBlueBallOrnamentBlock() {
        super(BLOCK_ID);
    }
}
